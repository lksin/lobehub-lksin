...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.billingPage.billing.downgrade.confirmBody':
    'This downgrades the workspace to Solo immediately. All extra seats are removed and members lose access. This cannot be undone.',
  'workspace.billingPage.billing.downgrade.confirmCta': 'Downgrade to Solo',
  ...
  'workspace.billingPage.billing.planBadge.cancelled': 'Cancelling',
  ...
  'workspace.billingPage.credits.status.inactiveCta': 'Subscribe',
  'workspace.billingPage.credits.status.inactiveDesc':
    'Subscription is inactive. Credits have stopped refreshing — re-subscribe to restore the pool.',
